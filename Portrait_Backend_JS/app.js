...
const fs = require('fs')
const mongoUri = "mongodb+srv://Server:NyAozTBiMCTm5k0f@cluster0.vzfbt.mongodb.net/?retryWrites=true&w=majority"
require('./Portrait')
...
app.post("/SignIn", function(req, res){
  ...
  Portrait.exists({UserName: UserName}, function(err, doc){
      ...
      myProfile = Portrait.findById(myToken)
      .then((myProfile) =>{
...
app.post("/getProfile", function (req,res){
    ...
    profile = Portrait.findById(token)
    .then((profile) =>{
    res.json(profile)
